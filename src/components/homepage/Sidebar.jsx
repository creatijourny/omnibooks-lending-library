...
const Sidebar = ({categories, activeId}) => {
    return (
        <div>
            <h1 className='text-xl md:text-3xl font-bold text-center border border-b shadow py-1 mb-4 text-linear-to-bl bg-gradient-to-r from-fuchsia-700 to-orange-700 bg-clip-text text-transparent'>Categories</h1>
